...
public static class TextCleaner
{
    static Dictionary<string, string> nameMap = new Dictionary<string, string>()
    {
        ...
        {"ui_main_name_c07", "Mizuki Okimura"},
        {"ui_main_name_c08", "So Sejima"},
        {"ui_main_name_c09", "Boss"},
        {"ui_main_name_c11", "Mayumi Matsushita"},
        {"ui_main_name_c16", "Pewter"},
        {"ui_main_name_c17", "Shoko Nadami"},
        {"ui_main_name_c18", "Mama"},
        {"ui_main_name_c51", "Inspector"},
        {"ui_main_name_c52", "Policeman"},
        {"ui_main_name_c59", "Bodyguard"},
        {"ui_main_name_c71", "#89"},
        {"ui_main_name_c78", "Radio"},
        {"ui_main_name_c91", "Akasaka"},
